...
<div class="box" id="login" style="width:20%;margin-left:40%;margin-right:40%;margin-top: 10%; opacity: 0.8;">
...
<script type="text/javascript">
  ...
  function showWxLogin(){
    ...
    var url="https://open.weixin.qq.com/connect/qrconnect?appid=wx242f65c58fd5929e&redirect_uri=http://account.chengyiwm.com/authority-mgr/view/wxLogin&response_type=code&scope=snsapi_login&state=state#wechat_redirect";
   // url="http://ydjr.dev.chengyiwm.com/authority-mgr/wxLogin.jsp";
    newWindow= window.open(url,
                    'newwindow',
                    'modal=yes,height=600, width=800, top='
                    + iTop
                    + ',left='
                    + iLeft
                    + ', toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
    timer=window.setInterval("checkNewWindowClosed()",100);
